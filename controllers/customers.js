...
exports.findAll = asyncErrorHandler(async (req, res, next) => {
    ...
    await Customers.findAll({ where: condition, limit: dataLimit, offset: dataOfset })
        .then(data => {
            res.json({ "data": data });
        })
        .catch(err => {
...
exports.findOne = asyncErrorHandler(async (req, res, next) => {
    const id = req.params.id;
    await Customers.findByPk(id)
        .then(data => {
            if (!data) {
